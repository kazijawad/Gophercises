// Package cyoa is for building Choose Your Own Adventure
...
func init() {
	tpl = template.Must(template.New("").Parse(defaultHanderTmpl))
}

var tpl *template.Template

var defaultHanderTmpl = `
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
// chapter includes a title, the paragraphs it is composed
