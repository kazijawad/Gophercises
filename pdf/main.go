...
func main() {
	lineItems := []LineItem{

		{
			...
			UnitName:       "Hammer",
			PricePerUnit:   1123, // in cents
			UnitsPurchased: 1233,
		}, {
			UnitName:       "Acrylic Sheet",
	...
	pdf.MultiCell(124.0, lineHt*1.5, "(123) 456-7890\nkazijawad@cmu.edu\nkazijawad.nyc", gofpdf.BorderNone, gofpdf.AlignRight, false)
	...
	// Summary - Billing, Invoice & Date of Issue
	...
	summaryBlock(pdf, xIndent*2.0+lineHt*12.5, bannerHt+lineHt*2.0, "Invoice Number", "000000123")
	summaryBlock(pdf, xIndent*2.0+lineHt*12.5, bannerHt+lineHt*6.25, "Date of Issue", "03/13/2020")
